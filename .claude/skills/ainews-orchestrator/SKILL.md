...
7개 수집 작업을 **동시에** 띄운다(한 메시지에 여러 Agent 호출, `run_in_background: true`).
...
| news-collector | general-purpose | opus | domestic(6개 매체) | 3~5 | news-collection | `_workspace/{date}/01_collect_domestic.json` |
